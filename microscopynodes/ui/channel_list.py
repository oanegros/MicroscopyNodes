...
class ChannelDescriptor(bpy.types.PropertyGroup):
    ...
    cmap : bpy.props.EnumProperty(
        ...
        items=[
            ...
            ("FIJI", "From Fiji LUT...", "Load from a fiji file" ,"FILE", 1),
            ("VIRIDIS", "Viridis", "bids:viridis","IPO_LINEAR", 2),
            ("PLASMA", "Plasma","bids:plasma", "IPO_LINEAR", 3),
            ("COOLWARM", "Coolwarm","matplotlib:coolwarm", "LINCURVE", 4),
            ("ICEFIRE", "IceFire","seaborn:icefire", "LINCURVE", 5),
            ("TAB10", "Tab10","seaborn:tab10", "OUTLINER_DATA_POINTCLOUD", 6),
            ("BRIGHT", "Bright","tol:bright", "OUTLINER_DATA_POINTCLOUD", 7),
        ], 
